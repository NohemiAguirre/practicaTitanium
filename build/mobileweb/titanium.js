...
var require = {
	app: {
		analytics: true,
		copyright: "2016 by daniel",
		deployType: "development",
		description: "",
		guid: "f69eac6a-85d4-413a-9666-aed526d4e371",
		id: "com.daniel.FileSystem2",
		name: "FileSystem2",
		names: {},
		publisher: "daniel",
		url: "",
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","5703f26a9a711cbd6ee61fd1");
	...
	p.setString("acs-oauth-secret-development","Q8zQTvrKCaXeQOFPF47xQAueSSPmKNVO");
	p.setString("acs-oauth-key-development","cWf9EVck4p83hLBxa2VcLoWA4ARv5v8j");
	p.setString("acs-api-key-development","l0FSkgx1wO3o1qi2EiJPmeJpYPUTphfY");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","dO9nyLHpgFsjDpVWAZ");
	...
	p.setString("acs-oauth-secret-production","CC3DCBpEdslrYP0XR7Gx9Glqmi5Gg4Ox");
	p.setString("acs-oauth-key-production","QsuHMIy27qMBCJH2I54bazOgNBN1WmMi");
	p.setString("acs-api-key-production","B7GGKdZVukECpUPLCNDKIDXW2w7pWamo");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","MY6unqW0bldeqZ0MdW");
	p.setString("appc-org-id","100104358");
	p.setString("appc-creator-user-id","69d0f86c-73dd-4ac3-9963-5a33ff11fc90");
});
